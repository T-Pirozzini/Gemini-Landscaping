    ...
    <nav className="navbar sticky top-0 z-10 shadow-lg p-4 bg-[#2F3E46]">
      <div className="container mx-auto flex flex-col md:flex-row items-center justify-between">
        ...
        <div className="logo flex items-center mb-4 md:mb-0">
          ...
          <h1 id="title" className="text-4xl font-bold pl-4 text-white font-['Alegreya']">
            Gemini Landscaping
          </h1>
        </div>
        ...
        <ul className="flex flex-col md:flex-row space-y-4 md:space-y-0 md:space-x-12">
          <li className="nav-item text-2xl text-[#CAD2C5] hover:cursor-pointer hover:text-green-500" onClick={focusAbout}>
            About us
          </li>
          <li className="nav-item text-2xl text-[#CAD2C5] hover:cursor-pointer hover:text-green-500" onClick={focusServices}>
            Services
          </li>
          <li className="nav-item text-2xl text-[#CAD2C5] hover:cursor-pointer hover:text-green-500" onClick={focusContact}>
            Contact us
          </li>
        </ul>
        ...
        <ul className="flex space-x-4">
          <li className="social-icon" style={{ color: '#CAD2C5' }}>
            <a href="https://www.instagram.com/gemini_landscaping/" target="_blank" rel="noopener noreferrer">
              <FaInstagram alt="Instagram" className="w-6 h-6 hover:cursor-pointer hover:text-green-500" />
            </a>
          </li>
          <li className="social-icon" style={{ color: '#CAD2C5' }}>
            <a href="mailto:andy@gemini-landscaping.com">
              <FaEnvelope alt="Email" className="w-6 h-6 hover:cursor-pointer hover:text-green-500" />
            </a>
          </li>
          <li className="social-icon text-[#CAD2C5]">
            <a className="flex items-center hover:cursor-pointer hover:text-green-500" href="tel:+12508160038">
